    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            max-width: 400px; /* Adjusted width for vertical layout */
            width: 100%;
        ...
        .card img {
            width: 100%;
            height: 250px; /* Adjusted height for vertical layout */
            object-fit: cover;
...
<div class="card">
    <div class="card-content">
        ...
        <button class="btn btn-primary" name="btn1" id="btn1" type="submit">Submit </button>
    </div>
</div>
...
<div class="card">
    <div class="card-content">
        ...
        <button class="btn btn-primary" name="btn2" id="btn2" type="submit">Submit </button>
